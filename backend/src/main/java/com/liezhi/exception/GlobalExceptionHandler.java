...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAccessDenied(AccessDeniedException ex) {
        return ResponseEntity.status(403).body(ApiResponse.error(403, "无权限"));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleDataIntegrity(DataIntegrityViolationException ex) {
        ...
        if (msg != null && msg.contains("uk_phone")) {
            return ResponseEntity.status(409).body(ApiResponse.error(10001, "手机号已注册"));
        }
        return ResponseEntity.status(409).body(ApiResponse.error(400, "数据冲突"));
    }
